class DebitCredit
  ...
  attr_accessor :date, :debit_amount, :memo, :d_list_id, :credit_amount, :c_list_id
  ...
  def save
    debit = Debit.create(date: date, debit_amount: debit_amount, memo: memo, d_list_id: d_list_id)
